...
public struct JSONOutwardTransformer<Output: HTTPResponseOutputProtocol, Context: AWSMiddlewareContext>: TransformProtocol {
    ...
    public func transform(_ output: HttpResponse, context: Context) async throws -> Output {
        func bodyDecodableProvider() throws -> Output.BodyType {
            ...
            return try JSONDecoder.awsCompatibleDecoder().decode(Output.BodyType.self,
                                                               from: responseBody)
        }
